...
window.PROMPTS = (function () {
  ...
  /** Ритм урока: два коротких спринта с обязательной паузой между ними. */
  var SPRINT_PLAN = '2 спринта × ~15 мин, пауза 2–3 мин между ними';
  ...
  function contractBlock(p) {
    return [
      ...
      '2. Ритм: ' + SPRINT_PLAN + '. Урок ~' + p.lessonLabel + ' минут, всего заданий ' + p.qRange +
      ...
      'Основная подача — по ' + p.ru + ', но перевод фидбека обязателен всегда. ' +
