...
(function () {
  ...
  // фазу App.nextUp берёт из «сегодня», а не из аргумента: без фиксации даты
  // кейс краснеет сам собой с 08.09.2026, когда живой фазой становится Ф1
  describe('2.6.3: «Дальше» при закрытой фазе', function () { withToday(WED, function () {
    fresh();
