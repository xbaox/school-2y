...
(function () {
  ...
  describe('2.7.8 Б5: очередь по сроку — Б14 раньше Б12; К не в очереди; общий блок последним', function () {
    withToday('2026-11-02', function () {
      ...
      // 2.8.1: у Б16.1 своя дорожка — math, пометки «общий блок» у математики нет
      eq(line('math'), 'следующий: Б16.1 · ' + title('B16.1'),
        'своих не осталось — урок Б16 (математика); открытый К строку не занимает');
