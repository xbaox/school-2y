...
(function () {
  ...
  describe('2.7.0 миграция v3: слияние сохраняет старейший id и примеры', function () {
    ...
    eq(d1.examples[0].text, 'запись ученика D-1',
      'первый пример — живая запись ученика, та, что была до канонического текста');
  ...
  describe('2.7.0 миграция v3: у каждого открытого долга есть пример', function () {
    ...
    eq(lone.examples[0].text, 'запись ученика D-10', 'и это его собственная запись');
  });
