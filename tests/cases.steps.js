...
(function () {
  ...
  // check() судит по «сегодня»: без фиксации даты цикл дозревает сам собой
  // и с 27.09.2026 кейс уходит в шторку повышения ступени
  describe('цикл A-03: истёкшая пауза остаётся в счёте', function () { withToday('2026-09-16', function () {
    school(3, '2026-09-08');
