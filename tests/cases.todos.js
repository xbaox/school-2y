...
(function () {
  ...
  describe('2.6.2: тексты дел — состав и полнота', function () {
    ...
    ok(g.why.indexOf('How many credits will I get for my previous school abroad') > 0, 'вопрос 1 по-английски');
    ok(g.why.indexOf('сколько кредитов зачтут за прошлую школу за границей') > 0, 'вопрос 1 по-русски');
