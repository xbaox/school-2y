...
(function () {
  ...
  describe('2.7.6 Э7: подписи блоков', function () {
    ...
    eq(State.block('B9').note, 'Опорные задания и глоссарий — пакет 2.8.0.', 'Б9');
    eq(State.block('B10').note, 'OSSLT — провинциальный тест грамотности, условие диплома; конец ноября 2026, ' +
      'точная дата до 15.10. Опорные задания — пакет 2.8.0 (или 2.8.1, если материалы придут позже).', 'Б10');
