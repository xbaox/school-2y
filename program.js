/* ============================================================
   ...
   Под полоской свежести каждой дорожки — её следующий урок (2.7.8).
   ============================================================ */
...
(function () {
  ...
  function render() {
    ...
    return '<h1>Программа</h1>' +
      ...
      'урок, минималка не считается. 0–3 дня зелёный · 4–5 жёлтый · 6+ красный. ' +
      'Под дорожкой — её следующий урок: его же предлагает «поменять урок».</p>' +
      (window.Waterfall ? Waterfall.fullBars(null, { next: true }) : '') + '</section>' +
