  ...
  var M4_TODOS = [
    {
      ...
      set: {
        ...
        due: '2026-09-14',
        why: 'Ответы — одной строкой в карточку Радара q-2026-09-08 и в окно «Английский + карьера». Credit Counselling Summary закрывает кредиты, российские годы, официальный класс, онлайн-кредиты; часы общественной работы — норма и форма; OSSLT — в списке ли на ноябрь, дата.'
      }
    },
    {
      id: 'mt4vmss12dy03k',
