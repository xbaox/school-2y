...
(function (pack) {
  ...
  blocks: [
    ...
    {
      id: 'B1', track: 'write', title: 'Язык учёбы и абзац', deadline: '2026-08-23',
      lessons: [
        {
    ...
    {
      id: 'B2', track: 'math', title: 'Линейные уравнения и системы', deadline: '2026-08-26',
      lessons: [
        {
    ...
    {
      id: 'B3', track: 'write', title: 'Чтение и письмо OSSLT', deadline: '2026-08-27',
      lessons: [
        {
    ...
    {
      id: 'B4', track: 'math', title: 'Квадратичные функции', deadline: '2026-09-01',
      lessons: [
        {
