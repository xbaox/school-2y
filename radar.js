...
window.Radar = (function () {
   ...
   * 2.7.8: страна прошлой школы не называется — репозиторий публичный; «зачем»
   * редакции 2.7.7 в данных узнаёт State.migrate по маскам мест замены (State.QUASI_278).
   */
  var SEED_TODOS = [
    {
   ...
   * 2.7.8: третий пункт без страны прошлой школы; прежние строки в данных
   * переписывает State.migrate по маскам мест замены. Добор ключуется текстами
   * QUESTIONS_EXTRA — они не менялись.
   */
